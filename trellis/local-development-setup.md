...
3. Optionally configure the IP address `vagrant_ip:` at the top of `vagrant.default.yml` to allow for multiple boxes to be run concurrently (default is `192.168.50.5`).
